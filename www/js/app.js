...
.config(function ($translateProvider) {
  $translateProvider.translations('es', {
    ...
    'ERROR_00': 'Página de campañas indisponible. Por favor, intenta de nuevo más tarde.',
  ...
  $translateProvider.translations('en', {
    ...
    'ERROR_HEADER': 'Uh oh!',
    'ERROR_00': 'Cannot reach campaigns site. Please try again later.',
  ...
  $translateProvider.translations('pt', {
    ...
    'ERROR_HEADER': 'Que pena!',
    'ERROR_00': 'O site das campanhas não está disponível. Por favor, tente novamente mais tarde.',
